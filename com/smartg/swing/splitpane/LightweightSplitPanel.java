 ...
 */
public class LightweightSplitPanel extends JPanel implements SplitPaneContainer {

    private static final long serialVersionUID = -6824869232774936222L;
    public GSplitPane msp;

    public LightweightSplitPanel() {
	...
	if (!msp.continuousLayout && msp.drag != null) {
	    ...
	    // System.out.println(r + " " + msp.drag.getDividerComponent());
    ...
    /**
     * Adds component to GSplitPane. Since children in GSplitPane never overlap,
