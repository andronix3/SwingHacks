...
public class GComboBox2D_DataEditor<E> extends GComboBoxEditor<E> {
    ...
    ListCellRenderer<E> renderer = new ListCellRenderer<E>() {
    ...
    @Override
    public E getValue() {
	return component.getList().getSelectedValue();
    }

    protected static class GDataPanel_2D<E> extends GComboBoxEditorPanel<E> {
