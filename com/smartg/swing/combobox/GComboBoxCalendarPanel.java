...
public class GComboBoxCalendarPanel extends GComboBoxEditorPanel<String> {
	...
	cdays.setFixedCellHeight(20);
	cdays.setFixedCellWidth(20);
	...
	Map<String, Integer> displayNames = cal.getDisplayNames(Calendar.DAY_OF_WEEK, Calendar.SHORT, Locale.getDefault());
	...
	current.setText(cal.getDisplayName(Calendar.MONTH, Calendar.SHORT, Locale.getDefault()) + " " + cal.get(Calendar.YEAR));
    }
}